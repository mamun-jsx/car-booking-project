        ...
        <div className="relative z-10 flex items-center justify-center h-full text-center text-white px-4">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl">
              We are your trusted car booking partner since 2023. Offering safe,
              affordable, and convenient rides — anytime, anywhere.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16 flex flex-col md:flex-row gap-10">
        ...
        <div className="md:w-1/2">
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            booking date, and confirm your ride. Payments are made in cash upon
            approval, ensuring no worries about online transactions.
          </p>
